...
const SIM_heading = "Master math interactive" ;
...
function setup(){
	...
	blue_line_1. style("background-color" , "rgb(255 , 102 , 102 )");
	blue_line_1. hide();

	blue_line_2 = createDiv();
	blue_line_2. style("background-color" , "rgb(255 , 102 , 102 )");
	blue_line_2. hide();
...
function draw(){
	...
	text("Master Math Interactive", textHeadX * scl_x + imgX , textHeadY * scl_y + imgY);
	...
	textAlign(LEFT,CENTER);
	text("Test this master interactive providing a very dynamic solution for creating interactive math", textSubHX * scl_x + imgX , textSubHY * scl_y + imgY);
